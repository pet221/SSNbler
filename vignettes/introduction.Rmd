...
# rmd style
knitr::opts_chunk$set(collapse = FALSE, comment = "#>", warning = FALSE, message = FALSE, fig.pos = 'H')
```
...
```{r mf-input, fig.cap = "The Middle Fork Stream Network.", fig.alt = "The Middle Fork Stream Network.", fig.align = "center", out.width = "90%"}
library(ggplot2)
ggplot() +
...
betwen zero and one ($0 \leq AFV \leq 1$). The AFV for the most downstream edge in a network will always
...
related to mean summer tempearture, while there is moderate evidence
