...
"MF_obs"
#'
#' #' MF_Knapp: Prediction locations on Knapp Creek, in the Middle Fork Basin, Idaho.
#'
#' \code{MF_Knapp} is an \code{sf} object with POINT geometry representing prediction locations and covariates on Knapp Creek, Middle Fork Basin, Idaho, USA. 
#'
