...
"_PACKAGE"
#'
#' @importFrom sf st_agr st_as_sf st_as_text st_buffer st_cast st_coordinates st_crosses st_crs st_crs<- st_drop_geometry st_equals st_geometry st_geometry<- st_geometry_type st_intersection st_intersects st_is_longlat st_join st_length st_line_sample st_linestring st_nearest_feature st_nearest_points st_read st_sfc st_write st_zm write_sf
...
#' @importFrom SSN2 copy_lsn_to_temp ssn_import
